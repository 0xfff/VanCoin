                    ...
                    map<string, vector<string> >& mapMultiSettingsRet)
{
    ...
    {
        // Don't overwrite existing settings so command line settings override barcoin.conf
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "barcoin.pid"));
